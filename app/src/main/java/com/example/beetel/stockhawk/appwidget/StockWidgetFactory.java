...
public class StockWidgetFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public void onDataSetChanged() {
        ...
        mCursor = mContext.getContentResolver().query(QuoteProvider.Quotes.CONTENT_URI, new String[]{QuoteColumns._ID, QuoteColumns.SYMBOL, QuoteColumns.PERCENT_CHANGE, QuoteColumns.CHANGE, QuoteColumns.BIDPRICE, QuoteColumns.CREATED, QuoteColumns.ISUP}, QuoteColumns.ISCURRENT + "=?", new String[]{"1"}, null);
    }
    @Override
